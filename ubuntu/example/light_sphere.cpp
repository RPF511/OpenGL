...
void init_light(void){
    ...
    GLfloat lit_amb[4] = {0.4,0,0,1};
    GLfloat lit_pos[4] = {3,3,-4,1}; 
    GLfloat lit_dif[4] = {0.8,0,0,1}; 
    GLfloat lit_spc[4] = {1,1,1,1};
...
void mydisplay(){
    ...
    GLfloat mat_amb[4] = {0.3,0,0,0};
    GLfloat mat_dif[4] = {0.8,0,0,0};

    GLfloat mat_spc[4] = {1,1,1,0};
    GLfloat mat_emi[4] = {0.3,0,0,0};
    GLfloat mat_shi[1] = {40};
